 ...
 *              de couleurs du plan technique, générateur d'IDs.
 *
 ...
 * @version     1.0.0
 *
 * @exports {Array}    TAG_TYPES
 * @exports {Object}   TAG_COLORS
 * @exports {Object}   TAG_LABELS
 ...
 * @exports {function} getPalette
 * @exports {function} uid
 * @exports {function} resetId
 * @exports {function} setNextId
 * @exports {function} svgUrl
 */
...
export const TAG_LABELS = { SWI: "Standard Work Instruction", IC: "Instruction de contrôle", PC: "Point de contrôle", LC: "Liste de contrôle", AQE: "Appareil qualité embarqué" };

/** Formats papier standards (dimensions en mm). Clé "Personnalisé" = valeurs par défaut modifiables. */
export const FORMATS = { "A0-paysage":{w:1189,h:841},"A1-paysage":{w:841,h:594},"A2-paysage":{w:594,h:420},"A3-paysage":{w:420,h:297},"A4-paysage":{w:297,h:210},"A0-portrait":{w:841,h:1189},"A1-portrait":{w:594,h:841},"A2-portrait":{w:420,h:594},"A3-portrait":{w:297,h:420},"A4-portrait":{w:210,h:297},"Personnalisé":{w:800,h:500} };
...
export const ZONE_COLORS = ["#1565C0","#00838F","#E65100","#6A1B9A","#AD1457","#F57F17","#4E342E","#37474F"];
...
/** Remet le compteur d'IDs à 120 (utilisé lors d'un "Nettoyer" document). */
export const resetId = () => { _id = 120; };
/** Avance le compteur après chargement d'un JSON pour éviter les collisions. */
export const setNextId = (n) => { if (n > _id) _id = n; };

/** Convertit un SVG texte en data URL pour utilisation dans <img>. */
