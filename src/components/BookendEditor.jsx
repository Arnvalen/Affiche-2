/**
 * @file        BookendEditor.jsx
 * @module      src/components/BookendEditor
 * @description Éditeur des panneaux Entrée/Sortie : tags du panneau + catégories + éléments.
 *
 ...
 * @version     1.0.0
 *
 * @exports {Component} BookendEditor
 */
import { produce } from "immer";
import { uid } from "../theme";
import { Btn, Input, SectionCard } from "./ui";
