/**
 * @file        StepsEditor.jsx
 * @module      src/components/StepsEditor
 * @description Éditeur des étapes du process : titre, tags, opérations, points de contrôle.
 *
